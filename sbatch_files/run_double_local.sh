...
do
  python ihead_full_main.py max_iters=10000 log_probes=True eval_delta=5  task_name=dormant_double_tasks_retry fine_grid_log=0 seperate_loss=True seed=27\
