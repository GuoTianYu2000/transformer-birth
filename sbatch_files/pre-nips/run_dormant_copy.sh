...
python ihead_full_main.py max_iters=5000 log_probes=True eval_delta=5  model_args.n_layers=${layer} model_args.n_heads=${head} \
        ...
        optim_args.use_sgd=False optim_args.learning_rate=0.0003 optim_args.weight_decay=1e-4 optim_args.batch_size=512 data_name=dormant_copy\
        model_args.dim=256 save_dir=/data/tianyu_guo/birth/gens/special/dormant_copy/model_L${layer}_H${head}_bos1_delim0
