...
for mix_p in "${params[@]}"
do
  python ihead_full_main.py max_iters=10000 log_probes=True eval_delta=5  task_name=dormant_copy_interpolate fine_grid_log=0 seperate_loss=True seed=53\
        ...
        save_dir=/data/tianyu_guo/birth/gens/pre_final/dormant_copy_interpolate_seed53
done
