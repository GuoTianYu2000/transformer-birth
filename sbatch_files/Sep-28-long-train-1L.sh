...
# only ATTN in the first layer, and only MLP in the last layer
    ...
    optim_args.use_sgd=False optim_args.learning_rate=0.0003 optim_args.weight_decay=0 optim_args.batch_size=512 \
    save_dir=/data/tianyu/birth/gens/pre-iclr/dynamics/long_train_no_weight_decay num_data_workers=60
