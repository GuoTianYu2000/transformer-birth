...
python ihead_full_main.py max_iters=5000 log_probes=True eval_delta=5  model_args.n_layers=${layer} model_args.n_heads=${head} \
        ...
        data_args.delimiter_p=0 fine_grid_log=1000 wandb_args.name=dormant_dynamics seperate_loss=True\
...
python ihead_full_main.py max_iters=1000 log_probes=True eval_delta=5  model_args.n_layers=1 model_args.n_heads=1 seperate_loss=True\
        ...
        data_args.delimiter_p=0 fine_grid_log=500 wandb_args.name=dormant_test\
        optim_args.use_sgd=False optim_args.learning_rate=0.0003 optim_args.weight_decay=1e-4 optim_args.batch_size=512 task_name=dormant_copy\
