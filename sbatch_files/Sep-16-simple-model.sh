...
# The first try
    python ihead_full_main.py max_iters=${iter_num} log_probes=True eval_delta=5  task_name=dormant_copy fine_grid_log=${iter_num} seperate_loss=True seed=42 device_num=0\
    use_simple_model=True simple_model_args.n_layers=${layer_idx} simple_model_args.use_vo=True simple_model_args.use_ln_in_copy_layer=True simple_model_args.no_attn=[2]\
