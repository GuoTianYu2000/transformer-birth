...
# sgd with lr 00003
    ...
    # optim_args.use_sgd=True optim_args.learning_rate=0.0003 optim_args.weight_decay=1e-4 optim_args.batch_size=512 \
    # save_dir=/data/tianyu/birth/gens/pre-iclr/dynamics/dormant_copy_sgd \
...
# sgd with lr 0003
    ...
    # data_args.k=${k} data_args.fixed_special_toks=True data_args.bos_num=1 data_args.delimiter_p=0 data_args.delim_num=1\
    # wandb_args.name=dormant_copy\
    # optim_args.use_sgd=True optim_args.learning_rate=0.003 optim_args.weight_decay=1e-4 optim_args.batch_size=512 \
    # save_dir=/data/tianyu/birth/gens/pre-iclr/dynamics/dormant_copy_sgd \
...
# sgd with lr 03
    ...
    # data_args.k=${k} data_args.fixed_special_toks=True data_args.bos_num=1 data_args.delimiter_p=0 data_args.delim_num=1\
    # wandb_args.name=dormant_copy\
    # optim_args.use_sgd=True optim_args.learning_rate=0.3 optim_args.weight_decay=1e-4 optim_args.batch_size=512 \
    # save_dir=/data/tianyu/birth/gens/pre-iclr/dynamics/dormant_copy_sgd \
...
# sgd with lr 3
    ...
    # data_args.k=${k} data_args.fixed_special_toks=True data_args.bos_num=1 data_args.delimiter_p=0 data_args.delim_num=1\
    # wandb_args.name=dormant_copy\
    # optim_args.use_sgd=True optim_args.learning_rate=3 optim_args.weight_decay=1e-4 optim_args.batch_size=512 \
    # save_dir=/data/tianyu/birth/gens/pre-iclr/dynamics/dormant_copy_sgd \
